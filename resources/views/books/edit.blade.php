    ...
    <div class="container">
        ...
        <form action="{{ route('books.update', $book) }}" method="POST" class="form-horizontal">
            ...
            <div class="form-group mb-3">
                ...
                <div class="col-md-6">
                    <input type="text" id="genre" name="genre" class="form-control" value="{{ old('genre', $book->genre) }}">
                    @error('genre')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="col-md-6">
                    <input type="number" id="publication_year" name="publication_year" class="form-control" value="{{ old('publication_year', $book->publication_year) }}">
            ...
            <div class="form-group mb-3">
                ...
                <div class="col-md-6">
                    <input type="number" id="pages" name="pages" class="form-control" value="{{ old('pages', $book->pages) }}">
                    @error('pages')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="col-md-6">
                    <select id="status" name="status" class="form-select">
                        <option value="to_read" {{ old('status', $book->status) == 'to_read' ? 'selected' : '' }}>To Read</option>
            ...
            <div class="form-group mb-3">
                ...
                <div class="col-md-6">
                    <input type="date" id="started_at" name="started_at" class="form-control" value="{{ old('started_at', $book->started_at ? $book->started_at->format('Y-m-d') : null) }}">
                    @error('started_at')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
             ...
             <div class="form-group mb-3">
                ...
                <div class="col-md-6">
                    <input type="date" id="finished_at" name="finished_at" class="form-control" value="{{ old('finished_at', $book->finished_at? $book->finished_at->format('Y-m-d') : null) }}">
                    @error('finished_at')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="col-md-6">
                    <input type="number" id="rating" name="rating" class="form-control" min="1" max="5" value="{{ old('rating', $book->rating) }}">
                    @error('rating')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="col-md-6">
                    <textarea id="notes" name="notes" class="form-control">{{ old('notes', $book->notes) }}</textarea>
                    @error('notes')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
